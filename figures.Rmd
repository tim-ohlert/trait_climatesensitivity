...
alphamod.1 <- lmer(log_alpha~SPEI.comp*site + (1|year) + (1|replicate), data = hv_climate) # within-site diversity change. At whih sites are SPEI changes through time related to alpha?
